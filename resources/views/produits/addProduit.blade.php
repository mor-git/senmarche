                        ...
                        <div class="card-body">
                            <form method="post" action="{{ url('/storeProduit') }}" id="validationform" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-md-5">
                                        <input required="" name="name" type="text" min="6" max="100" placeholder="Nom du Produit." class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Prix Produit</label>
                                    <div class="col-12 col-md-5">
                                        <input type="text" name="prix" required="" data-parsley-maxlength="6" placeholder="Prix par Kg." class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
