...
@section('contenu')
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Ajout Profil</h5>
                    <div class="card-body">
                        <form method="post" action="{{ url('/storeProfil')}}" id="validationform" data-parsley-validate="" novalidate="">
                            <input type="hidden" value="{{csrf_token()}}" name="_token" id="token" />
                            
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Libelle</label>
                                <div class="col-12 col-sm-9 col-lg-6">
                                    <input type="text" name="name" required="" data-parsley-maxlength="6" placeholder="Ajout d'un Profil." class="form-control">
                                </div>
                            </div>
