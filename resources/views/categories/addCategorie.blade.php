...
@section('contenu')
    ...
    <div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Categorie </h2>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Ajout Catégorie</h5>
                    <div class="card-body">
                        <form method="post" action="{{ url('/storeCategorie')}}" id="validationform" data-parsley-validate="" novalidate="">
    ...
    <!-- ============================================================== -->
    @endsection
    <!-- <form action="{{ url('/storeCategorie') }}" method="post">
<input type="hidden" value="{{csrf_token()}}" name="_token" id="token" />
    <input type="text" name="name" id=""><br><br><br>
