...
<div class="dashboard-wrapper">
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Secteur d'intervention</h2>
            ...
            @endif
            <br>
            <div style="text-align : right; margin-right : 12px;"><a href="{{ url('/addCategorie_profil')}}" class="btn btn-outline-success">Nouveau Secteur</a></div><br>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                            ...
                            <table class="table">
                                ...
                                @foreach($profils as $profil)
                                    <tr>
                                        ...
                                        <td>{{ $profil->name }}</td>
                                        <td>
                                            <a href="{{ url('/editCategorie_profil', $profil->id) }}" >
