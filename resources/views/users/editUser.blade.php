                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ url('/modif_user', $user->id ) }}" id="validationform">
                                @csrf
                                <div class="form-group row">
                                    <label for="nom" class="col-12 col-sm-3 col-form-label text-sm-right">Nom..</label>
                                    <div class="col-12 col-md-5">
                                        <input id="nom" name="nom" type="text" class="form-control @error('nom') is-invalid @enderror" value="{{ $user->name }}"  autocomplete="nom" autofocus>
                                        @error('nom')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-md-5">
                                        <input id="phone" name="phone" value="{{ $user->phone }}" type="text" min="1" max="100"  class="form-control @error('phone') is-invalid @enderror"  autofocus>
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-md-5">
                                        <input id="adresse" type="text" value="{{ $user->adresse }}" name="adresse" class="form-control @error('phone') is-invalid @enderror">
                                        @error('adresse')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-md-5">
                                        <input id="email" name="email" value="{{ $user->email }}" type="email" min="1" max="100"  class="form-control @error('email') is-invalid @enderror">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
