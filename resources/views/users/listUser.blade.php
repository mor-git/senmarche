...
<div class="dashboard-wrapper">
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Liste des Users</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Liste Utilisateurs</h5>
                            ...
                            <table class="table">
                                ...
                                @foreach($users as $user)
                                    <tr style="text-align: center;">
                                        ...
                                        <td>{{ $user->adresse }}</td>
                                        <td>{{ $user->email }}</td>
                                        <td>{{ $user->profils->name }}</td>
                                        <td>
                                            <!-- <input type="hidden" value="{{ $user->id }}" id="input"> -->
                                            <a href="{{ url('edit_user',$user->id) }}">
                                                <button class="btnBorder"><i class='fas fa-edit' style='font-size:15px;color:green;'></i></button>
                                            </a>&nbsp;
                                            <!-- <a href="{{ url('supp_Produit',$user->id) }}"> -->
 
                                            <a href=""  data-toggle="modal" data-target="#exampleModal">    
                                                <button class="lien btnBorder" value="{{ $user->id }}"><i class='fas fa-trash-alt' style='font-size:15px;color:red'></i></button>
                                            </a>
                                        </td>
                                    </tr>
                                <?php $i++; ?>
...
<script>
    $(document).ready(function(){
        ...
        $('.lien').click(function(){
            let id = $(this).val();
            $('#deleteForm').attr('action','/supp_user/'+id);
